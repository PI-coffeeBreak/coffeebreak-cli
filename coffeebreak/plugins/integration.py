...
class PluginContainerIntegration:
    ...
    def _create_plugin_mount_paths(self, 
                                  plugin_config: Dict[str, Any], 
                                  plugin_dir: str) -> Dict[str, str]:
    ...
    def _mount_plugin_volumes(self, container_name: str, mount_paths: Dict[str, str]) -> bool:
        ...
        try:
            ...
            for host_path, container_path in mount_paths.items():
                ...
                exec_result = container.exec_run(f"mkdir -p {os.path.dirname(container_path)}")
    ...
    def _register_plugin_with_core(self, 
                                  container_name: str, 
                                  plugin_name: str, 
...
EOF
    ...
    def _get_mounted_plugins_from_core(self, container_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            exec_result = container.exec_run([
                'sh', '-c', 'ls /opt/coffeebreak/plugins/.registry/*.json 2>/dev/null || true'
            ])
