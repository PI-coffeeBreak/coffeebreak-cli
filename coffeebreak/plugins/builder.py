...
class PluginBuilder:
    ...
    def __init__(self, verbose: bool = False):
        ...
        self.known_native_modules = {
            ...
            "huggingface_hub", "cv2", "PIL", "Pillow",
            "lxml", "psycopg2", "cryptography",
            "pyzmq", "zmq", "greenlet", "gevent"
        }
    ...
    def _exclude_native_modules(self, 
                               build_dir: str, 
                               additional_excludes: List[str]) -> Set[str]:
