...
class DevelopmentEnvironment:
    ...
    def initialize(self, organization: str = "PI-coffeeBreak", version: str = "1.0.0", 
                   env_type: str = "venv", env_path_or_name: Optional[str] = None, 
    ...
    def _setup_python_environment(self, env_type: str, env_path_or_name: Optional[str], 
                                python_path: Optional[str]) -> Dict:
        """
